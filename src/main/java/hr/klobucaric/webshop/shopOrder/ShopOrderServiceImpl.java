...
public class ShopOrderServiceImpl implements ShopOrderService{
    ...
    private ShopOrderDto mapShopOrderToDto(ShopOrder shopOrder, Set<OrderLineDto> orderLineDtos){
        return new ShopOrderDto(shopOrder.getId(),shopOrder.getOrderDate(),shopOrder.getOrderTotal(),
    ...
    private OrderLineDto mapOrderLineToDto(OrderLine orderLine){
        return new OrderLineDto(orderLine.getId(),orderLine.getQty(),orderLine.getPrice(),orderLine.getProductItem().getId(),orderLine.getShopOrder().getId());
    }
