...
public class PaymentMethodServiceImpl implements PaymentMethodService{
    ...
    private PaymentMethodDto mapPaymentMethodToDto(PaymentMethod paymentMethod) {
        return new PaymentMethodDto(paymentMethod.getId(), paymentMethod.getProvider(), paymentMethod.getAccountNumber()
                , paymentMethod.getExpiryDate(), paymentMethod.getUser().getId(), paymentMethod.getPaymentType().getId());
    }
